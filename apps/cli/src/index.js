...
import { getMeshClient, AgentRole, AgentStatus, Logger, Mesh } from '@ai-agent/core-sdk';
...
program
    ...
    try {
        ...
        const unsubscribe = client.subscribeToHeartbeats(meshId, (heartbeats) => {

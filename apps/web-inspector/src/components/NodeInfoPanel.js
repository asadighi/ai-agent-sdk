...
export function NodeInfoPanel({ node, isOpen, onClose }) {
    if (!node)
        return null;
    ...
    return (<Collapse in={isOpen} orientation="horizontal" sx={{ position: 'absolute', right: 0, top: 0, height: '100%' }}>
      <Paper elevation={3} sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Box>
            ...
            {!isDisconnected && (<Typography variant="caption" color="text.secondary">
          ...
          {isDisconnected && (<Box sx={{ mt: 2, p: 2, bgcolor: '#FFEBEE', borderRadius: 1 }}>
...
//# sourceMappingURL=NodeInfoPanel.js.map
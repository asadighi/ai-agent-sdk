...
import { AgentRole, AgentStatus, MeshClient, Heartbeat, Agent, Mesh, Logger, LogLevel, BrowserStorage } from '@ai-agent/core-sdk';
...
function App() {
  ...
  const [workerType, setWorkerType] = useState<AgentRole>(
    (searchParams.get('workerType') as AgentRole) || AgentRole.Worker
  );

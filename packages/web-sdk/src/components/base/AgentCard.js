...
export const AgentCard = ({ agentId, role, status, lastSeen, isLeader = false, onClick, className, style }) => {
    ...
    return (<div className={className} style={baseStyle} onClick={onClick}>

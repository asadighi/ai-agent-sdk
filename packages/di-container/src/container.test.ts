...
import { Container, DefaultContainer, container } from './container';
...
describe('Container', () => {
    ...
    describe('default container instance', () => {
        afterEach(() => {
            ...
            const defaultContainer = container as DefaultContainer;
            (defaultContainer as any).dependencies.clear();
            (defaultContainer as any).factories.clear();
        });
    ...
    describe('type safety', () => {
        it('should maintain type information', () => {
            ...
            const token = Symbol('test');
            const value: TestInterface = { value: 'test' };
            
            testContainer.register(token, value);
            const result = testContainer.get<TestInterface>(token);
        ...
        it('should work with factory functions that return typed values', () => {
            ...
            const token = Symbol('test');
            const factory = (): TestInterface => ({ value: 'test' });
